...
# CHANGED class RePipeRetrieve has been moved to CEPProcessing and renamed GenbankRetrieve 
# CHANGED class RePipeIO has been moved to CEPPreprocessing and renamed SequenceUtilities
...
class GenbankRecordTests(unittest.TestCase): 
	...
	def setUp(self):
		pass # TODO add unit tests to CEPPreprocessing
